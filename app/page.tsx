        ...
        <div className="cardInside p-5 flex flex-col text-xl text-black">
          <div className="container">
            <div className={"overlay"}>
              ...
              <h1 className={"text"}>
                Happy New Year from Glorious Lane LLC! 🎉.As we welcome 2025, we
                want to express our heartfelt gratitude for your trust and
                support over the past year. At Glorious Lane LLC, our commitment
                to delivering excellence and ensuring timely, reliable shipping
